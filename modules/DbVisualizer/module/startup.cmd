...
set DBVIS_HOME=#[release.drive.letter]:\Modules\DbVisualizer
set JAVA_EXEC=#[release.drive.letter]:\Modules\Java-11\bin\javaw
...
set DBVIS_OPT=%DBVIS_OPT% -Duser.home=#[release.drive.letter]:\Documents\Local
